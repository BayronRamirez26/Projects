...
function CleanersPage() {
  ...
  useEffect(() => {
    async function fetchProducts() {
      try {
        const response = await fetch(`${API_BASE_URL}/products/subcategory?q=cleaners`); // Updated to use full URL
    ...
    <>
      ...
      <main>
        <div className="banner">
          <img src="\categoryHeaders\extras\cleaners.png" alt="Banner Limpiadores" className="banner-image" />
        </div>
