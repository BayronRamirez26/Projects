...
function BluesPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=blues`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/bluesBanner.png" alt="Banner Blues" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
