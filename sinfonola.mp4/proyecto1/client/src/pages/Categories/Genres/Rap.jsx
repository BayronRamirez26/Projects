...
function RapPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=rap`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/rapBanner.png" alt="Banner Rap" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
