...
function LatinaPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=latin`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/latinaBanner.png" alt="Banner Latina" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
