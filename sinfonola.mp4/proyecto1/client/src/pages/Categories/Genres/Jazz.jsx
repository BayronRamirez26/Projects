...
function JazzPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=jazz`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/jazzBanner.png" alt="Banner Jazz" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
