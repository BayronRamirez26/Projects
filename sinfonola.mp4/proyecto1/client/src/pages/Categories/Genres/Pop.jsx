...
function PopPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=pop`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/popBanner.png" alt="Banner Pop" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
