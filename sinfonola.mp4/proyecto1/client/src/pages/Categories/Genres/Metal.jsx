...
function MetalPage() {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=metal`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/metalBanner.png" alt="Banner Metal" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
