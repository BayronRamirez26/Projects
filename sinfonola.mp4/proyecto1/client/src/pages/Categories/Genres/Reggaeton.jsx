...
function ReggaetonPage() {
  const [products, setProducts] = useState([]);
  const [allArtists, setAllArtists] = useState([]);
              
  useEffect(() => {
    const fetchItems = async () => {
      const response = await fetch(`${API_BASE_URL}/products/formats/genre?q=reggaeton`);
    ...
    <>
      ...
      <main>
          <div className="banner">
            <img src="/categoryHeaders/genres/reggaetonBanner.png" alt="Banner Reggaeton" className="banner-image" />
          </div>
        <CategoryLayout
          items={products}
