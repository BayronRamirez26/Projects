...
public class WhiteboardDto
{
    ...
    public WhiteboardDto(int learningComponentId, string learningComponentName, double positionX, double positionY, double positionZ, double sizeX, double sizeY, double rotationX, double rotationY, Guid learningSpaceId)
    {
    ...
    public WhiteboardDto(string learningComponentName, double positionX, double positionY, double positionZ, double sizeX, double sizeY, double rotationX, double rotationY, Guid learningSpaceId)
    {
        this.learningComponentName = learningComponentName;
        PositionX = positionX;
        PositionY = positionY;
