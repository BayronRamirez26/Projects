...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class AssignRoleToUserRequest : IParsable 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="AssignRoleToUserRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AssignRoleToUserRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
