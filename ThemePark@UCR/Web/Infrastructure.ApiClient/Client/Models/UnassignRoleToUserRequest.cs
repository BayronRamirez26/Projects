...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class UnassignRoleToUserRequest : IParsable 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="UnassignRoleToUserRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UnassignRoleToUserRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UnassignRoleToUserRequest();
        }
        /// <summary>
