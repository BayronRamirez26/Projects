...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class PermissionDto : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="PermissionDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static PermissionDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
