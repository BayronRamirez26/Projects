...
using System;
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.CreateLevel {
    /// <summary>
    ...
    public class CreateLevelRequestBuilder : BaseRequestBuilder 
    {
        ...
        public CreateLevelRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/create-level?buildingAcronym={buildingAcronym}&campusName={campusName}&ceilingColor={ceilingColor}&floorColor={floorColor}&learningSpacesCount={learningSpacesCount}&levelId={levelId}&levelNumber={levelNumber}&siteName={siteName}&sizeX={sizeX}&sizeY={sizeY}&sizeZ={sizeZ}&universityName={universityName}&wallsColor={wallsColor}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="CreateLevelRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateLevelRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/create-level?buildingAcronym={buildingAcronym}&campusName={campusName}&ceilingColor={ceilingColor}&floorColor={floorColor}&learningSpacesCount={learningSpacesCount}&levelId={levelId}&levelNumber={levelNumber}&siteName={siteName}&sizeX={sizeX}&sizeY={sizeY}&sizeZ={sizeZ}&universityName={universityName}&wallsColor={wallsColor}", rawUrl)
        {
        }
