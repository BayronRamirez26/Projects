...
#nullable enable
        public async Task<List<Models.LearningSpaces>?> PostAsync(Action<RequestConfiguration<GetLearningSpaceTypeByLstypeidRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
