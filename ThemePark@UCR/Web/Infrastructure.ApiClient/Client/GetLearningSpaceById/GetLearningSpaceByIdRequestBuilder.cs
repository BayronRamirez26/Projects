...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.GetLearningSpaceById {
    /// <summary>
...
#nullable enable
        public async Task<Models.LearningSpaces?> PostAsync(Action<RequestConfiguration<GetLearningSpaceByIdRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<LearningSpaces> PostAsync(Action<RequestConfiguration<GetLearningSpaceByIdRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Models.LearningSpaces>(requestInfo, Models.LearningSpaces.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
