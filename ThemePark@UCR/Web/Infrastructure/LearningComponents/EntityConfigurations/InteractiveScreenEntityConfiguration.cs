...
internal class InteractiveScreenEntityConfiguration : IEntityTypeConfiguration<InteractiveScreen>
{
    public void Configure(EntityTypeBuilder<InteractiveScreen> builder)
    {

        builder.ToTable("InteractiveScreen", schema: "ThemePark");
