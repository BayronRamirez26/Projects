...
public class WhiteboardDto
{
    ...
    public WhiteboardDto(int learningComponentId, string learningComponentName, double positionX, double positionY, double positionZ, float sizeX, float sizeY, float rotationX, float rotationY, Guid learningSpaceId)
    {
    ...
    public WhiteboardDto(string learningComponentName, double positionX, double positionY, double positionZ, float sizeX, float sizeY, float rotationX, float rotationY, Guid learningSpaceId)
    {
        this.learningComponentName = learningComponentName;
        PositionX = positionX;
        PositionY = positionY;
