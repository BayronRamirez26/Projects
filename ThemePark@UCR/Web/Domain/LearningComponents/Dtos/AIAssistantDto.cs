...
public class AIAssistantDto
{
    ...
    public AIAssistantDto (int learningComponentId, string learningComponentName, double positionX, double positionY, double positionZ, float sizeX, float sizeY, float rotationX, float rotationY, Guid learningSpaceId)
    {
