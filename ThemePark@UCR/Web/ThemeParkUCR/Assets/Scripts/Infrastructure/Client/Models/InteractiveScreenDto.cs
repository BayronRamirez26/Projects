...
namespace UCR.ECCI.IS.ExampleProject.Infrastructure.ApiClient.Client.Models {
    public class InteractiveScreenDto : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="InteractiveScreenDto"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static InteractiveScreenDto CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"learningSpaceId", n => { LearningSpaceId = n.GetGuidValue(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteGuidValue("learningSpaceId", LearningSpaceId);
