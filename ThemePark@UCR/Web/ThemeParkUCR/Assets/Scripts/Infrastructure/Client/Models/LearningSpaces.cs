...
namespace UCR.ECCI.IS.ExampleProject.Infrastructure.ApiClient.Client.Models {
    ...
    {
        /// <summary>The accessPoints property</summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public GuidWrapper? Type { get; set; }
#nullable restore
#else
        public GuidWrapper Type { get; set; }
#endif
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"accessPoints", n => { AccessPoints = n.GetCollectionOfObjectValues<AccessPoint>(AccessPoint.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"type", n => { Type = n.GetObjectValue<GuidWrapper>(GuidWrapper.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<AccessPoint>("accessPoints", AccessPoints);
            ...
            writer.WriteObjectValue<GuidWrapper>("type", Type);
