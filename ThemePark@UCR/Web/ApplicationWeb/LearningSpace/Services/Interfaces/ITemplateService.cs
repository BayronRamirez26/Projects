...
/// <summary>
/// Defines service functions for managing Templates entity.
/// </summary>
public interface ITemplateService
{
    ...
    /// <summary>
    /// This method allows to create whiteboards from a template and store them in the database.
    /// </summary>
    ...
    /// <summary>
    /// This method allows to create projectors from a template and store them in the database.
    /// </summary>
    /// <param name="template"></param>
    /// <param name="LearningSpace"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// This method allows to create interactive screens from a template and store them in the database.
    /// </summary>
    /// <param name="template"></param>
    /// <param name="LearningSpace"></param>
    /// <returns></returns>
    ...
    /// <summary>
    /// This method allows to add a component to a template.
    /// </summary>
