...
public class LearningSpaceService : ILearningSpaceService
{
    ...
    {
        return await _learningRepository.GetWhiteboardOfALearningSpacesAsync(id);
    }

    public async Task<IEnumerable<InteractiveScreen>> GetInteractiveScreenOfALearningSpacesAsync(GuidWrapper id)
    {
        return await _learningRepository.GetInteractiveScreenOfALearningSpacesAsync(id);
    }

    public async Task<IEnumerable<AccessPoint>> GetAccessPointsOfALearningSpacesAsync(GuidWrapper id)
    {
        return await _learningRepository.GetAccessPointsOfALearningSpacesAsync(id);
    }
}