...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class AddBuildingObjectToLevelRequest : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="AddBuildingObjectToLevelRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AddBuildingObjectToLevelRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new AddBuildingObjectToLevelRequest();
        }
        /// <summary>
