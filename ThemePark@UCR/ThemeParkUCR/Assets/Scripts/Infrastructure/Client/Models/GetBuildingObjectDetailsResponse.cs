...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class GetBuildingObjectDetailsResponse : IParsable 
    {
...
#nullable restore
        ...
        public static GetBuildingObjectDetailsResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetBuildingObjectDetailsResponse();
        }
        /// <summary>
