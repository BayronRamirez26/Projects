...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class CreateRoleRequest : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CreateRoleRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreateRoleRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
