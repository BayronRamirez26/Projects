...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class GetBOTemplatesOfTypeAndPlaneRequest : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="GetBOTemplatesOfTypeAndPlaneRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static GetBOTemplatesOfTypeAndPlaneRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new GetBOTemplatesOfTypeAndPlaneRequest();
        }
        /// <summary>
