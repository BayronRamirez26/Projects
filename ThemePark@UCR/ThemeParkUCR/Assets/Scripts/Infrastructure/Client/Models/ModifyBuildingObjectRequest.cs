...
namespace UCR.ECCI.PI.ThemePark_UCR.Infrastructure.ApiClient.Client.Models {
    public class ModifyBuildingObjectRequest : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ModifyBuildingObjectRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ModifyBuildingObjectRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ModifyBuildingObjectRequest();
        }
        /// <summary>
